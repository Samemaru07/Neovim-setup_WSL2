...
return {
    s("report", {
        t({
            ...
            "]{Harano Aji Mincho}",
            "",
            "\\usepackage[top=25mm,bottom=25mm,left=20mm,right=20mm,bindingoffset=10mm]{geometry}",
            ...
            "",
            "% ----------------------------------------------------------------",
            "以下のブロックを有効化すると、Chapterを使わずSectionを 1. から開始できます",
            "% 0.1. 形式に戻す場合は、このブロックをコメントアウト",
            "\\makeatletter",
