...
local yank_messages = {
    ...
    {
        title = "カレン あっ…今の、いい感じ", -- カレン（コードギアス）
        message = "%sのコピー、完璧ね。…ふふ、やるじゃない。さすが、さめまるくん。",
    },
    {
        title = "真矢 おてつだい！", -- 真矢（蒼穹のファフナー）
        message = "%s分のコピー、私も手伝ったよ。…一緒にやると、ちょっと楽しいね。",
    },
    {
        title = "カガリ まったく…", -- カガリ・ユラ・アスハ（ガンダムSEED）
